...
/* ./.libs/lt-lzmainfo.c - temporary wrapper executable for .libs/lzmainfo.exe
...
const char * LIB_PATH_VALUE   = "/home/win64/src/xz-5.2.2/src/liblzma/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/home/win64/bin;/home/win64/lib;/home/win64/src/xz-5.2.2/src/liblzma/.libs;";
const char * TARGET_PROGRAM_NAME = "lzmainfo.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# lzmainfo - temporary wrapper script for .libs/lzmainfo.exe\n", f);
  ...
  fputs ("    echo \"lzmainfo.exe:lzmainfo:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"lzmainfo.exe:lzmainfo:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"lzmainfo.exe:lzmainfo:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
  ...
  fputs ("    PATH=/home/win64/bin:/home/win64/lib:/home/win64/src/xz-5.2.2/src/liblzma/.", f);
  fputs ("libs:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/win64/src/xz-5.2.2/src/liblzma/.libs:$PATH\"\n", f);
  fputs ("\n", f);

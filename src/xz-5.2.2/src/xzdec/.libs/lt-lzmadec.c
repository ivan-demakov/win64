...
/* ./.libs/lt-lzmadec.c - temporary wrapper executable for .libs/lzmadec.exe
...
const char * TARGET_PROGRAM_NAME = "lzmadec.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# lzmadec - temporary wrapper script for .libs/lzmadec.exe\n", f);
  ...
  fputs ("    echo \"lzmadec.exe:lzmadec:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"lzmadec.exe:lzmadec:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"lzmadec.exe:lzmadec:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);

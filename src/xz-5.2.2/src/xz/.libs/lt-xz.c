...
/* ./.libs/lt-xz.c - temporary wrapper executable for .libs/xz.exe
...
const char * TARGET_PROGRAM_NAME = "xz.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# xz - temporary wrapper script for .libs/xz.exe\n", f);
  ...
  fputs ("    echo \"xz.exe:xz:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"xz.exe:xz:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"xz.exe:xz:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);

...
const char * LIB_PATH_VALUE   = "/home/win64/lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/home/win64/bin;/home/win64/lib;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' /home/win64/lib/libiconv.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    PATH=/home/win64/bin:/home/win64/lib:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/win64/lib:$PATH\"\n", f);
  fputs ("\n", f);
